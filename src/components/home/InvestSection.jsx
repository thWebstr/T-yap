...
const InvestSection = () => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Heading */}
        <h2 className="font-dm font-extrabold text-[36px] md:text-[52px] leading-[58px] text-white max-w-[752px]">
          Invest in the Future of Public Transport Payments in Nigeria
        </h2>

        {/* Subtitle */}
        <p className="font-lato text-[18px] md:text-[22px] leading-[28px] text-white mt-6 max-w-[732px]">
        ...
        <button
          ...
          className="relative flex items-center justify-between bg-white text-[rgba(213,67,5,1)] font-lato font-bold text-[18px] md:text-[20px] rounded-[12px] px-6 md:px-8 mt-10 w-[220px] md:w-[240px] h-[60px] md:h-[68px] hover:bg-[rgba(255,255,255,0.9)] transition-all duration-300 shadow-md"
        >
