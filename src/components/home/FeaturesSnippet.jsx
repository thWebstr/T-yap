...
const FeaturesSnippet = () => {
  ...
  return (
    ...
    >
      {/* Section Header */}
      <h2 className="text-center text-3xl md:text-4xl font-dm font-semibold text-black mb-10">
        Features
      </h2>

      {/* Feature content */}
     <div className="w-full text-center">
        <h3 className="font-dm text-[20px] md:text-[22px] font-semibold text-center text-[rgba(0, 0, 0, 1)] mb-4">
          1. Biometric Transport Payment System
        </h3>

        <ul className="text-black font-lato text-[18px] space-y-2 list-disc list-inside inline-block text-left">
          <li>
      ...
      <div className="w-full md:w-[880px] flex justify-end mt-6">
        <button
          ...
          className="font-lato text-[16px] underline text-[rgba(255,76,0,1)] leading-[40px] transition-all hover:text-orange-600"
          style={{
            width: "57px",
            height: "26px",
